    ...
    <div id="container">
        ...
        <div id="mainBox">
            ...
            <div class="notice">
                ...
                <p>Feb. 23, 2011</p>
        Someone has contributed a Recent Comments widget to the plugin, so I'll be testing and releasing that within the next few weeks. That update will also include a few JavaScript fixes.<br /><br />

                If anyone would like to contribute to the plugin, you can do so by <a href="https://github.com/thinkswan/Facebook-Comments-for-WordPress">forking the project on GitHub</a> and letting me know when you'd like an update pushed to WordPress.<br /><br />

                <strong>If you discover a bug</strong>, please add it to the <a href="https://github.com/thinkswan/Facebook-Comments-for-WordPress/issues">GitHub Issues</a> page. <strong>You can always find help</strong> by <a href="#demo">posting in the Live Demo</a> below or by <a href="http://wordpress.org/tags/facebook-comments-for-wordpress?forum_id=10">leaving a message in the WordPress forums</a>.<br /><br />

                <strong>If the latest version isn't working for you</strong>, you can <a href="http://wordpress.org/extend/plugins/facebook-comments-for-wordpress/download/">download a previous version here</a> (v1.5.2 worked for nearly everyone, but lacks combined comment counts and notifications).
            </div>
            ...
            <span class="instruction indent">
	            If you're looking for help, you can try posting in the <strong><a href="#demo">Live Demo</a></strong> above or leave a message in the <strong><a href="http://wordpress.org/tags/facebook-comments-for-wordpress?forum_id=10">WordPress forums</a></strong>. Should you discover a bug, please add it to the <strong><a href="https://github.com/thinkswan/Facebook-Comments-for-WordPress/issues">GitHub Issues</a></strong> page.<br /><br />
